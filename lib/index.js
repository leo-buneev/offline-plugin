...
var OfflinePlugin = (function () {
  ...
  _createClass(OfflinePlugin, [{
    ...
    value: function apply(compiler) {
      ...
      var checkRuntimeFn = function checkRuntimeFn(compilation, callback) {
        ...
        console.log("---------------HERRE", hasRuntime, _this2.__tests.ignoreRuntime);

        callback();
        return;
      };

      var addAssetsFn = function addAssetsFn(compilation, callback) {
        ...
        (function () {
          ...
          if (isWebpack5) {
            ...
            compiler.hooks.thisCompilation.tap(plugin, function (compilation) {
              compilation.hooks.processAssets.tapAsync(_extends({}, plugin, {
              ...
              function (compilationAssets, callback) {
                /*console.log("-------");
